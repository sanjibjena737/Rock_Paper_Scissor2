...
l1 = Label(root, text='Player', font=('Algerian', 30), bg="orange", fg="black")
l2 = Label(root, text='Computer', font=('Algerian', 30), bg='orange', fg='black')
l3 = Label(root, text='Vs', font=('Algerian', 40), fg='red')
...
def game(player):
    ...
    canvas.create_text(390, 600, text='Result:- ' + res,
                       fill="green", font=('Algerian', 25), tag='result')
...
rock_b = Button(root, text='Rock',font=('arial', 10, 'bold'), bg="yellow", fg="red", command=lambda: game(1))
rock_b.place(x=28, y=500)

# Button for selecting paper
paper_b = Button(root, text='Paper', font=('arial', 10, 'bold'), bg="yellow", fg="red", command=lambda: game(2))
paper_b.place(x=125, y=500)

# Button for selecting scissor
scissor_b = Button(root, text='Scissor', font=('arial', 10, 'bold'), bg="yellow", fg="red", command=lambda: game(3))
scissor_b.place(x=225, y=500)

# Button for clear
clear_b = Button(root, text='CLEAR', font=('Times', 15, 'bold'), bg="yellow", fg="red",
                 width=10, command=clear).place(x=345, y=455)
